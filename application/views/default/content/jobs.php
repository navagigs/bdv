    ...
    <div id="tf-blog" class="blog-post">
        <div class="container"> <!-- container -->
            <div class="section-header">
                <h2>Read<span class="highlight"><strong> Jobs</strong></span></h2>
				...
				if ($this->session->userdata('logged_in') == TRUE && $this->session->userdata('admin_level') == '5') { ?>
                        ...
                        <div class="comment">
                            ...
                            <input type="hidden" name="berita_id" value="<?php echo $berita->berita_id; ?>" />
                                ...
                                <textarea class="form-control" required="required" name="komentar_deskripsi" rows="6" placeholder="Comment..."></textarea>
...
<!-- Page Header
    ...
    <div id="tf-blog" class="blog">
        <div class="container"> <!-- container -->
            <div class="section-header">
                <h2>Jobs<span class="highlight"><strong></strong></span></h2>
                <div class="fancy"><span><img src="<?php echo base_url();?>templates/default/assets/img/icon-idigo.png" alt="..."></span></div>
            </div>
        </div>
                    ...
                    <div class="post-wrap"> <!-- Post Wrapper -->
                            <div class="media post"> <!-- post wrap -->
                                <div class="media-left"> 
                                    <a href="<?php echo site_url()?>jobs/read/<?php echo $row->berita_id.'/'.$this->CONF->seo($row->berita_judul)?>"> <!-- link to your post single page -->
                                ...
                                <div class="media-body">
                                    ...
                                    <a href="<?php echo site_url()?>jobs/read/<?php echo $row->berita_id.'/'.$this->CONF->seo($row->berita_judul)?>">
                                        <h5 class="media-heading"><strong>
                                    <a href="<?php echo site_url()?>jobs/read/<?php echo $row->berita_id.'/'.$this->CONF->seo($row->berita_judul)?>"><?php echo substr($row->berita_judul,0,60); ?></strong></h5>
                                    </a>
                            ...
                            <div class="post-meta"> <!-- Meta details -->
                                <ul class="list-inline metas pull-left"> <!-- post metas -->
                                    ...
                                    <li><a href="<?php echo site_url()?>jobs/read/<?php echo $row->berita_id.'/'.$this->CONF->seo($row->berita_judul)?>">Read More</a></li> <!-- read more link -->
                                </ul>
                            </div><!-- end Meta details --> 
                        </div><!-- end Post Wrapper -->
                     <?php } } else { ?>
                            <div class="media post"> <b>Tidak Ada Jobs</b></div>
					<?php 	} ?>   
                            ...
                            <nav>
                                <ul class="pagination">
                                    <li>
                      				  ...
                      				  <?php if ($jml_halaman > 1){ error_reporting(0); echo pages2($halaman, $jml_halaman, 'jobs/pages', $id=""); }?>
                                    </li>
                                </ul>
                            </nav>
                        </div>         
